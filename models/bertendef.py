...
class BERT_ENDEFModel(torch.nn.Module):
    def __init__(self, emb_dim, mlp_dims, dropout):
        ...
        self.bert = BertModel.from_pretrained('/home/minglq/Data/project/FakeNewsDetection/ENDEF-SIGIR2022/ENDEF_en/huggingface/bert-base-uncased', local_files_only=True).requires_grad_(False)
