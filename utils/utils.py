...
def metrics(y_true, y_pred):
    ...
    all_metrics['metric'] = all_metrics['f1']
    ...
    # 手动计算 acc_real 和 acc_fake
    all_metrics['acc_real'] = cm[0, 0] / (cm[0, 0] + cm[1, 0])  # 分子是真正例，分母是真正例 + 假反例
    all_metrics['acc_fake'] = cm[1, 1] / (cm[0, 1] + cm[1, 1])  # 分子是真反例，分母是假正例 + 真反例
